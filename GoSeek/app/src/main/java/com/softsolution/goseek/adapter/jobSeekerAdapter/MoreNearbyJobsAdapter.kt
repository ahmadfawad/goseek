...
class MoreNearbyJobsAdapter(
    private val list: ArrayList<DashbordData>,
    private val context: Context): RecyclerView.Adapter<MoreNearbyJobsAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view= LayoutInflater.from(context).inflate(R.layout.more_nearby_jobs_layout_vh,parent,false)
