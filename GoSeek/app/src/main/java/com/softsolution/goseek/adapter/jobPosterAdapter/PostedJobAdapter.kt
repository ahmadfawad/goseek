...
private val context: Context): RecyclerView.Adapter<PostedJobAdapter.ViewHolder>(){

    var listener: CallFragmentInterface? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view= LayoutInflater.from(context).inflate(R.layout.posted_job_vh,parent,false)
        ...
        fun bind(dashbordData: PostedDashbordData){
            ...
            itemView.setOnClickListener {
              //  callbackInterface.passResultCallback()
                ...
                listener?.passFragmentCallback("Job")
